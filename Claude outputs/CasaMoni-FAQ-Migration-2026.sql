...
-- ============================================================
-- PART 1: Renomear categorias existentes
-- ============================================================

UPDATE faq_categories SET nome = 'Tecnologia e Hub Fly' WHERE nome = 'Hub Fly';
UPDATE faq_categories SET nome = 'Moní Care' WHERE nome = 'Pós-venda e Moní Care';

-- ============================================================
-- PART 2: Novas categorias
-- ============================================================

INSERT INTO faq_categories (nome, ordem)
SELECT 'Entrega e Pós-Obra', 15
WHERE NOT EXISTS (SELECT 1 FROM faq_categories WHERE nome = 'Entrega e Pós-Obra');

INSERT INTO faq_categories (nome, ordem)
SELECT 'Licenciamento e Marca', 16
WHERE NOT EXISTS (SELECT 1 FROM faq_categories WHERE nome = 'Licenciamento e Marca');

INSERT INTO faq_categories (nome, ordem)
SELECT 'Suporte e Comunidade', 17
WHERE NOT EXISTS (SELECT 1 FROM faq_categories WHERE nome = 'Suporte e Comunidade');
...
INSERT INTO faq_articles (
  categoria_id, pergunta, resposta_resumida, resposta_completa,
  status, ordem, area_responsavel, palavras_chave, sinonimos,
  destaque, visibilidade, proxima_revisao
)
SELECT
  (SELECT id FROM faq_categories WHERE nome = 'Terrenos' LIMIT 1),
...
> **Dúvidas?** Abra um chamado no Sirene ou consulte seu executivo de novos negócios.$faq$,
  ...
  true, 'frank', '2027-09-18'::date
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Terrenos' LIMIT 1)
  AND pergunta = 'Quais são os critérios mínimos para um terreno ser considerado elegível pela Moní?'
);
...
> **Dúvidas?** Abra um chamado no Sirene ou fale com seu executivo de novos negócios.$faq$,
  ...
  false, 'frank', '2027-09-18'::date
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Terrenos' LIMIT 1)
  AND pergunta = 'Como funciona a prospecção de terrenos no modelo Moní?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Terrenos' LIMIT 1)
  AND pergunta = 'O que é o BCA e como ele avalia a viabilidade do terreno?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Terrenos' LIMIT 1)
  AND pergunta = 'Quais certidões e documentos o terrenista precisa apresentar?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Terrenos' LIMIT 1)
  AND pergunta = 'O que pode desqualificar um terreno no processo Moní?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Terrenos' LIMIT 1)
  AND pergunta = 'O que é o Comunicado de Uso e como ele afeta a prospecção?'
);
...
SELECT
  (SELECT id FROM faq_categories WHERE nome = 'Aprovações e Pré-Obra' LIMIT 1),
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Aprovações e Pré-Obra' LIMIT 1)
  AND pergunta = 'O que é o Projeto Legal e qual é o papel do franqueado nessa etapa?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Aprovações e Pré-Obra' LIMIT 1)
  AND pergunta = 'Como funciona a aprovação pelo condomínio e qual é o prazo típico?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Aprovações e Pré-Obra' LIMIT 1)
  AND pergunta = 'Quanto tempo leva para obter o alvará de construção?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Aprovações e Pré-Obra' LIMIT 1)
  AND pergunta = 'O que é o Planialtimétrico e quando ele é necessário?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Aprovações e Pré-Obra' LIMIT 1)
  AND pergunta = 'Quando a Moní aciona a garantidora e como o crédito de obra é liberado para início de obra?'
);
...
SELECT
  (SELECT id FROM faq_categories WHERE nome = 'Obra' LIMIT 1),
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Obra' LIMIT 1)
  AND pergunta = 'Qual é o cronograma típico de uma obra Moní e quais são as etapas?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Obra' LIMIT 1)
  AND pergunta = 'Quem contrata e gerencia os fornecedores durante a obra?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Obra' LIMIT 1)
  AND pergunta = 'O que acontece se a obra atrasar? Quais são os impactos e como é tratado?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Obra' LIMIT 1)
  AND pergunta = 'Como funciona o acompanhamento da obra pelo Hub Fly?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Obra' LIMIT 1)
  AND pergunta = 'O que é o Habite-se e como ele é obtido?'
);
...
SELECT
  (SELECT id FROM faq_categories WHERE nome = 'Tecnologia e Hub Fly' LIMIT 1),
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Tecnologia e Hub Fly' LIMIT 1)
  AND pergunta = 'Como faço para acessar o Hub Fly pela primeira vez?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Tecnologia e Hub Fly' LIMIT 1)
  AND pergunta = 'Como funciona o Kanban no Hub Fly e o que os cards representam?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Tecnologia e Hub Fly' LIMIT 1)
  AND pergunta = 'O que é o Sirene e quando devo usá-lo?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Tecnologia e Hub Fly' LIMIT 1)
  AND pergunta = 'Como atualizo meus dados de perfil no Hub Fly?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Tecnologia e Hub Fly' LIMIT 1)
  AND pergunta = 'Não consigo acessar um funil ou card no Hub Fly — o que fazer?'
);
...
SELECT
  (SELECT id FROM faq_categories WHERE nome = 'Entrega e Pós-Obra' LIMIT 1),
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Entrega e Pós-Obra' LIMIT 1)
  AND pergunta = 'Como funciona o protocolo de entrega das unidades ao terrenista?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Entrega e Pós-Obra' LIMIT 1)
  AND pergunta = 'O que é averbação e por que é necessária antes da venda das unidades?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Entrega e Pós-Obra' LIMIT 1)
  AND pergunta = 'Quais são os prazos de garantia das casas entregues?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Entrega e Pós-Obra' LIMIT 1)
  AND pergunta = 'O que acontece com o acerto financeiro após a entrega das unidades?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Entrega e Pós-Obra' LIMIT 1)
  AND pergunta = 'O terrenista pode vender a unidade recebida antes do Habite-se?'
);
...
SELECT
  (SELECT id FROM faq_categories WHERE nome = 'Moní Care' LIMIT 1),
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Moní Care' LIMIT 1)
  AND pergunta = 'O que é o Moní Care e como ele funciona?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Moní Care' LIMIT 1)
  AND pergunta = 'Como o terrenista deve acionar o Moní Care após problemas na unidade?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Moní Care' LIMIT 1)
  AND pergunta = 'O franqueado tem alguma responsabilidade no pós-entrega?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Moní Care' LIMIT 1)
  AND pergunta = 'O Moní Care cobre problemas causados por inquilinos ou compradores das unidades?'
);
...
SELECT
  (SELECT id FROM faq_categories WHERE nome = 'Licenciamento e Marca' LIMIT 1),
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Licenciamento e Marca' LIMIT 1)
  AND pergunta = 'O franqueado pode usar a marca Moní em suas comunicações e materiais?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Licenciamento e Marca' LIMIT 1)
  AND pergunta = 'Como funciona o licenciamento da marca e o que diz o COF sobre isso?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Licenciamento e Marca' LIMIT 1)
  AND pergunta = 'Posso criar redes sociais com a marca Moní para minha unidade?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Licenciamento e Marca' LIMIT 1)
  AND pergunta = 'O franqueado pode fazer campanhas de mídia paga usando a marca Moní?'
);
...
SELECT
  (SELECT id FROM faq_categories WHERE nome = 'Suporte e Comunidade' LIMIT 1),
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Suporte e Comunidade' LIMIT 1)
  AND pergunta = 'Quais são os canais oficiais de suporte da Moní para o franqueado?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Suporte e Comunidade' LIMIT 1)
  AND pergunta = 'Existe uma comunidade de franqueados Moní e como me engajo?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Suporte e Comunidade' LIMIT 1)
  AND pergunta = 'Como reporto um bug ou sugestão de melhoria para o Hub Fly?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Suporte e Comunidade' LIMIT 1)
  AND pergunta = 'Qual é o SLA de resposta do time Moní para chamados no Sirene?'
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM faq_articles
  WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Suporte e Comunidade' LIMIT 1)
  AND pergunta = 'Posso indicar outro franqueado para a rede Moní e existe algum benefício por isso?'
);
...
UPDATE faq_articles SET
  pergunta = 'A Moní ainda utiliza Seguro Garantia? Qual é a garantia atual entregue ao terrenista?',
  resposta_resumida = 'A Moní não utiliza mais Seguro Garantia. A garantia atual entregue ao terrenista é a Carta Fiança, contratada via Seven Garantias, LS Garantidora ou outra garantidora habilitada.',
  resposta_completa = $faq$## Qual é a garantia atual entregue ao terrenista?
...
> **Dúvidas?** Abra um chamado no Sirene ou envie uma mensagem para o time Jurídico via Hub Fly.$faq$,
  palavras_chave = ARRAY['carta fiança','seguro garantia','garantia terrenista','seven garantias','ls garantidora','instrumento garantidor','permuta garantia'],
  sinonimos = ARRAY['garantia para o dono do terreno','seguro do terreno','proteção terrenista'],
  area_responsavel = 'Jurídico'
WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Contratos e Garantias' LIMIT 1)
AND (
  pergunta ILIKE '%Seguro Garantia Moní%'
  OR pergunta = 'A Moní ainda utiliza Seguro Garantia? Qual é a garantia atual entregue ao terrenista?'
);
...
SELECT
  (SELECT id FROM faq_categories WHERE nome = 'Contratos e Garantias' LIMIT 1),
...
UPDATE faq_articles SET
  resposta_resumida = 'O terrenista recebe como garantia a Carta Fiança, um documento emitido por uma garantidora que assegura o recebimento das unidades mesmo que o empreendimento não seja concluído. É a proteção mais sólida disponível no mercado.',
  resposta_completa = $faq$## Como explicar de forma simples a segurança do terrenista?
...
> **Lembre:** nunca prometa valores exatos de indenização sem consultar o Jurídico — cada contrato tem suas especificidades.$faq$,
  palavras_chave = ARRAY['carta fiança','segurança terrenista','garantia permuta','seven garantias','instrumento garantidor','argumento terrenista'],
  sinonimos = ARRAY['proteção do dono do terreno','garantia ao proprietário','fiança imobiliária'],
  area_responsavel = 'Jurídico'
WHERE categoria_id = (SELECT id FROM faq_categories WHERE nome = 'Permuta' LIMIT 1)
AND pergunta ILIKE '%segurança do terrenista%';
...
SELECT
  (SELECT id FROM faq_categories WHERE nome = 'Permuta' LIMIT 1),
