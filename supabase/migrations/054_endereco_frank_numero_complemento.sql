-- Separar Número e Complemento no endereço da casa do franqueado
-- (formulário Novo Step 1) e refletir na rede_franqueados.
...
COMMENT ON COLUMN public.processo_step_one.endereco_casa_frank_numero IS 'Número do endereço da casa do franqueado.';
COMMENT ON COLUMN public.processo_step_one.endereco_casa_frank_complemento IS 'Complemento do endereço da casa do franqueado.';

ALTER TABLE public.rede_franqueados
  ADD COLUMN IF NOT EXISTS endereco_casa_frank_numero TEXT,
  ADD COLUMN IF NOT EXISTS endereco_casa_frank_complemento TEXT;

COMMENT ON COLUMN public.rede_franqueados.endereco_casa_frank_numero IS 'Número do endereço da casa do franqueado (importado/gerado do Step 1).';
COMMENT ON COLUMN public.rede_franqueados.endereco_casa_frank_complemento IS 'Complemento do endereço da casa do franqueado (importado/gerado do Step 1).';

-- Atualizar trigger para copiar também número e complemento para rede_franqueados
