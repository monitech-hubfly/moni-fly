-- ─── 122: seed de interações de exemplo para teste do Painel Sirene ──────────
-- Insere kanban_atividades para cards nativos (Funil Step One) e interações
-- diretas origem='sirene' (sem card). Idempotente: filtra por titulo+card_id.
-- Banco DEV: bgaadvfucnrkpimaszjv.supabase.co

-- ============================================================
-- PARTE 1 — Interações para cards do Funil Step One (nativo)
-- Usa os 5 primeiros cards ativos para não saturar o banco dev.
-- ============================================================
...
-- ============================================================
-- PARTE 2 — Interações diretas origem='sirene' (sem card)
...
-- ============================================================
-- PARTE 3 — Sub-interações (sirene_topicos) vinculadas às
-- interações sirene criadas na PARTE 2
-- ============================================================
