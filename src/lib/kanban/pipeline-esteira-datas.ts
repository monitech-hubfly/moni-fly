...
export const ESTEIRA_COLUNAS: readonly EsteiraColuna[] = [
  ...
  { slug: 'step_7', label: 'Enviar Cto', sla: 3, tipo: 'uteis', ordemGlobal: 9, faseId: 'd78771cb-f79d-4650-a056-f3e2dbc3f3a6' },
  { slug: 'passagem_wayser', label: 'Passagem', sla: 2, tipo: 'uteis', ordemGlobal: 10, faseId: '5f48a367-699b-4dc4-a310-377fc7d0ff88' },
  { slug: 'convertidos', label: 'Convertidos', sla: null, tipo: 'uteis', ordemGlobal: 11, faseId: 'eda6139e-65f4-43d4-955f-026a488524be' },
