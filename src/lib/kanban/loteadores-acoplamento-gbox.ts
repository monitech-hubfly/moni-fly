...
export const LOTEADORES_ACOPLAMENTO_GBOX_CAMPOS = {
  memorialDescritivo: 'memorial_descritivo',
} as const;

export const LOTEADORES_ACOPLAMENTO_GBOX_CAMPOS_VISIVEIS = Object.values(
  LOTEADORES_ACOPLAMENTO_GBOX_CAMPOS,
);
