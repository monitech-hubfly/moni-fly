...
/**
 * Esteira canônica v1 — 19 fases ativas (ordem 1–19).
 * Displays alinhados às migrations 513–517.
 */
export const LOTEADORES_FASES_CANONICAS: readonly LoteadoresFaseCanon[] = [
  ...
  { ordem: 7, slug: FASE_SLUGS.LOTEADORES_ACOPLAMENTO, nome: 'Acoplamento', slaDias: 1 },
  { ordem: 8, slug: FASE_SLUGS.LOTEADORES_EXECUCAO_MATERIAL, nome: 'Executar Material', slaDias: 1 },
  { ordem: 9, slug: FASE_SLUGS.VALIDACAO_MONI_INC, nome: 'Validação', slaDias: 1 },
  { ordem: 10, slug: FASE_SLUGS.LOTEADORES_R2_PLANO_TEORICO, nome: 'R2 Apresentação', slaDias: 5 },
  { ordem: 11, slug: FASE_SLUGS.LOTEADORES_REVISOES, nome: 'Revisões + Forma Pgto', slaDias: 2 },
  { ordem: 12, slug: FASE_SLUGS.ACOPLAMENTO_GBOX_MONI_INC, nome: 'Acoplamento + Gbox', slaDias: 5 },
  { ordem: 13, slug: FASE_SLUGS.LOTEADORES_COMITE, nome: 'Comitê', slaDias: 3 },
  { ordem: 14, slug: FASE_SLUGS.REVISOES_POS_COMITE_MONI_INC, nome: 'Revisões', slaDias: 2 },
  { ordem: 15, slug: FASE_SLUGS.CTO_PRECEDENTES_MONI_INC, nome: 'Cto c/ Precedentes', slaDias: 3 },
  { ordem: 16, slug: FASE_SLUGS.LOTEADORES_DILIGENCIA, nome: 'Diligência', slaDias: 10 },
  { ordem: 17, slug: FASE_SLUGS.LOTEADORES_CTO_SHOWROOM, nome: 'Cto Showroom', slaDias: 3 },
  { ordem: 18, slug: FASE_SLUGS.PASSAGEM_WAYSERS_MONI_INC, nome: 'Passagem para Waysers', slaDias: 1 },
  { ordem: 19, slug: FASE_SLUGS.LOTEADORES_CONTRATO_PARCERIA, nome: 'Cto de Parceria', slaDias: 3 },
] as const;
...
/** Slugs na ordem canônica das 19 fases ativas. */
 ...
 * Ordena pela esteira canônica de 19 fases.
 */
