...
import { ensureRedeAnexoNumeroFranquiaColumn } from '@/lib/rede-ensure-anexo-column';
...
/** Upload COF, contrato, docs de empresa ou franqueado no bucket `rede-attachments`. */
