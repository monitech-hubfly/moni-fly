...
const BOARD_NODES: BoardNode[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: '/onboarding/mapa-batalha-bca-spe', label: 'Mapa, batalha e BCA' },
    ],
    x: 42,
    y: 40,
  },
  {
    ...
    links: [
      ...
      { href: '/onboarding/mapa-batalha-bca-spe', label: 'Texto operacional Mapa/BCA' },
  ...
  },
  {
    ...
    links: [
      { href: '/step-3', label: 'Step 3 no Hub' },
      { href: '/onboarding/esteira-negociacao-comite', label: 'Negociação e comitê' },
    ],
    x: 58,
    y: 24,
  },
  {
    ...
    links: [
      ...
      { href: '/onboarding/acoplamento-legal-credito', label: 'Onboarding acoplamento' },
      { href: '/step-5', label: 'Step 5 — Comitê' },
      { href: '/step-6', label: 'Step 6 — Diligência' },
      { href: '/step-7', label: 'Step 7 — Contrato' },
      { href: '/onboarding/diligencia-contrato', label: 'Diligência e contrato' },
    ],
    x: 72,
    y: 44,
  },
  {
    ...
    links: [
      { href: '/onboarding/custos-slas-drive', label: 'Custos, SLAs, Drive e lição de casa' },
  ...
  },
  {
    ...
    links: [{ href: '/onboarding/operacoes-pre-obra', label: 'Operações pré-obra' }],
    x: 38,
    y: 78,
  },
  {
    ...
    links: [
      { href: '/dashboard-novos-negocios', label: 'Dashboard' },
      { href: '/onboarding/meta-frank', label: 'Meta Frank' },
    ],
    x: 84,
    y: 58,
    pill: 'Meta',
