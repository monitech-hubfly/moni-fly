...
export default async function DueDiligenceAvaliacaoInicialPage() {
    ...
    <div className="min-h-screen bg-stone-50">
      <header className="border-b border-stone-200 bg-white">
        <div className="mx-auto flex h-14 max-w-7xl items-center px-4">
          ...
          <span className="text-stone-400 mx-2">/</span>
          <span className="font-semibold text-moni-dark">Due Diligence: avaliação inicial</span>
        </div>
      </header>
      <main className="mx-auto max-w-7xl px-4 py-8">
        <div className="card">
          <h1 className="text-xl font-bold text-moni-dark">Due Diligence: avaliação inicial</h1>
          <p className="mt-2 text-stone-600">
            Avaliação inicial do processo seletivo de candidatos (Due Diligence).
          </p>
