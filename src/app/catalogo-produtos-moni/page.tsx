...
export default async function CatalogoProdutosMoniPage() {
    ...
    <div className="min-h-screen bg-stone-50">
      <header className="border-b border-stone-200 bg-white">
        <div className="mx-auto flex h-14 max-w-7xl items-center px-4">
          ...
          <span className="font-semibold text-moni-dark">Catálogo de Produtos Moní</span>
        </div>
      </header>
      <main className="mx-auto max-w-7xl px-4 py-8">
        <div className="card">
          <h1 className="text-xl font-bold text-moni-dark">Catálogo de Produtos Moní</h1>
