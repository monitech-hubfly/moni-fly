  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8">
        <h1 className="text-2xl font-bold text-moni-dark">Etapas do processo</h1>
        <p className="mt-1 text-stone-600">
          Siga a ordem das etapas. O progresso é salvo automaticamente.
        </p>

        <section className="mt-8">
          <h2 className="mb-3 text-lg font-semibold text-stone-800">Step 1</h2>
          <p className="mb-3 text-sm text-stone-500">Banco de informações: etapas 1 a 5</p>
        ...
        <section className="mt-8">
          <h2 className="mb-3 text-lg font-semibold text-stone-800">Documentos</h2>
          ...
          <ul className="space-y-3">
            <li>
              <Link href={step3Href} className="step-card flex items-start gap-4">
                <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-moni-primary/10 text-sm font-semibold text-moni-primary">
                  3
                </span>
                <div>
                  ...
                  <p className="mt-0.5 text-sm text-stone-500">
                    {isMoni && !isOwner
                      ...
                      : 'Template de opções: baixar, preencher e anexar.'}
                  </p>
                </div>
              </Link>
            </li>
            <li>
              <Link href={step7Href} className="step-card flex items-start gap-4">
                <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-moni-primary/10 text-sm font-semibold text-moni-primary">
                  7
                </span>
                <div>
                  ...
                  <p className="mt-0.5 text-sm text-stone-500">
                    {isMoni && !isOwner
                      ...
                      : 'Template de contrato: baixar, preencher e anexar.'}
                  </p>
                </div>
              </Link>
            </li>
            <li>
              <Link href={step5Href} className="step-card flex items-start gap-4">
                <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-moni-primary/10 text-sm font-semibold text-moni-primary">
                  5
                </span>
                <div>
        ...
        <div className="mt-8 rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900">
          <strong>Rede:</strong> A ferramenta gera uma lista de contatos de condomínios, corretores
          e imobiliárias. Os dados são atualizados quinzenalmente.
        </div>
      </main>
    </div>
  );
