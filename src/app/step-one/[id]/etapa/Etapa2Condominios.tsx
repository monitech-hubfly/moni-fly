...
export function Etapa2Condominios({
  ...
  const handleChangeField = (
    condominioId: string,
    field: keyof ChecklistFormState,
    value: string,
  ) => {
    setForms((prev) => {
    ...
    <div className="mt-6 space-y-8">
      ...
      <section className="rounded-xl border border-stone-200 bg-white p-4 shadow-sm">
        ...
        <p className="mt-1 text-sm text-stone-600">
          Reutiliza a integração ZAP para listar condomínios da cidade com casas{' '}
          <strong>&gt; 5 MM</strong>. A busca usa apenas cidade e estado do processo (sem filtro de
          bairro/condomínio).
        </p>
        <button
          type="button"
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-stone-200 bg-stone-100">
                  ...
                  <th className="w-32 p-2 text-center">Qtd. casas</th>
                  <th className="w-40 p-2 text-center">Preço médio</th>
                  <th className="w-40 p-2 text-center">m² médio</th>
              ...
              <tbody>
                {condominios.map((c) => (
                  <tr key={c.id} className="border-b border-stone-100">
                    ...
                    <td className="p-2 text-center">{c.qtd_casas ?? '—'}</td>
            ...
            {condominios.map((c) => {
              ...
              return (
                <div key={c.id} className="rounded-lg border border-stone-200 bg-white">
                  ...
                  {isOpen && (
                    <div className="space-y-5 border-t border-stone-200 px-4 py-3">
                      {/* Bloco A — Lotes */}
                      <div>
                        ...
                        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                handleChangeField(c.id, 'casas_construindo_venda', e.target.value)
                              }
                              className="w-full rounded border border-stone-300 px-2 py-1.5 text-sm"
                            />
                          </div>
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                handleChangeField(c.id, 'casas_construindo_cliente', e.target.value)
                              }
                              className="w-full rounded border border-stone-300 px-2 py-1.5 text-sm"
                            />
                          </div>
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                handleChangeField(c.id, 'casas_tempo_medio_venda', e.target.value)
                              }
                              className="w-full rounded border border-stone-300 px-2 py-1.5 text-sm"
                            />
                          </div>
                        ...
                        <div className="mt-3 grid gap-3 sm:grid-cols-2">
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              onChange={(e) =>
                                handleChangeField(c.id, 'casas_impacto_negativo', e.target.value)
                              }
                              className="w-full rounded border border-stone-300 px-2 py-1.5 text-sm"
                            />
                          </div>
                          <div>
                            ...
                            <textarea
                              ...
                              onChange={(e) =>
                                handleChangeField(c.id, 'casas_erros_projeto', e.target.value)
                              }
                              className="w-full rounded border border-stone-300 px-2 py-1.5 text-sm"
                            />
                          </div>
      ...
      <form onSubmit={handleConcluir} className="border-t border-stone-200 pt-4">
        ...
        <button type="submit" disabled={savingEtapa} className="btn-primary mt-2 text-sm">
          Salvar e avançar
        </button>
      </form>
    </div>
