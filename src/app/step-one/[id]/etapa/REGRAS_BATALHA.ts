...
export const CATEGORIAS_REFORMA = [
  { id: "A", nome: "Estrutura e Fundação", valor: 65000, dificuldade: "dificil" as const, incerteza: "alta" as const },
  { id: "B", nome: "Impermeabilização e Infiltração", valor: 18000, dificuldade: "dificil", incerteza: "alta" },
  ...
  { id: "E", nome: "Revestimentos e Esquadrias", valor: 22000, dificuldade: "intermediario", incerteza: "normal" },
  { id: "F", nome: "Cozinha e Banheiros", valor: 15000, dificuldade: "intermediario", incerteza: "normal" },
  { id: "G", nome: "Fachada e Áreas Externas", valor: 25000, dificuldade: "intermediario", incerteza: "alta" },
...
const TOTAL_PESO_PRECO = PESOS_PRECO.distancia + PESOS_PRECO.esforco + PESOS_PRECO.incerteza + PESOS_PRECO.preco_nominal;
...
export function notaAmenidades(listing: { piscina?: boolean | null; marcenaria?: boolean | null }): number {
  let sum = 0;
...
export function notaFinalBatalha(notaAtributos: number, notaPreco: number, notaProduto: number): number {
