  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8">
        <div className="card">
          <h1 className="text-xl font-bold text-moni-dark">Due Diligence Frank</h1>
          <p className="mt-2 text-stone-600">
            Documentação e verificação do franqueado (Due Diligence do cadastro do franqueado).
          </p>
          <div className="mt-6 rounded-xl border border-dashed border-stone-200 bg-stone-50 p-8 text-center">
            ...
            <p className="mt-2 text-sm text-stone-400">
              Em breve você poderá acessar a Due Diligence Frank aqui.
            </p>
          </div>
        </div>
      </main>
