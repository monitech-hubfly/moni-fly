...
| Funil Divify | `/funil-moni-capital` | `724aef36-…` | 8 | Shared | Renomeado de Moní Capital; interno |
...
**Divify (8)**: `capital_recebimento` … `capital_concluido` / `capital_nao_elegivel`
